public class Main {
    public static void main(String[] args) {
        ...
        Автомобиль auto1 = new Автомобиль("Lada", "Granta",2015,"Россия","жёлтый",1.7);
        System.out.println(auto1);
        Автомобиль auto2 = new Автомобиль("Audi","A8 50 L TDI quattro",2020,"Германия","черный",3.0);
        System.out.println(auto2);
        Автомобиль auto3 = new Автомобиль("BMW","Z8",2021,"Германия","черный",3.0);
        System.out.println(auto3);
        Автомобиль auto4 = new Автомобиль("Kia","Sportage 4-го поколения",2018,"Южная Корея","красный",2.4);
        System.out.println(auto4);
        Автомобиль auto5 = new Автомобиль("Hyundai","Avante",2016,"Южная Корея","оранжевый",1.6);
